	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="panel panel-default">
				...
				<form action="${pageContext.request.contextPath}/orders/update1?id=${orders.id}&pagenum=${pageinfo.pageNum}&pageSize=${pageinfo.pageSize}"
					  method="post">
			<!--联系人信息/--> <!--费用信息--> <c:if test="${orders.orderStatus==1}">
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data text"><%--在线支付-${orders.payTypeStr}--%>
							<select class="form-control select2" style="width: 100%"
									name="payType">
								<c:if test="${orders.payType==0}">
									<option value="0" selected="selected">支付宝支付</option>
									<option value="1">微信</option>
									<option value="2">其他支付</option>
								</c:if>
								...
								<c:if test="${orders.payType==2}">
									...
									<option value="1">微信</option>
									<option value="2" selected="selected">其他支付</option>
								</c:if>
							</select></div>
